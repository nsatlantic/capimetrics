    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-8">
      <div>
        <h3 className="text-2xl lg:text-3xl font-black text-heading mb-2">
          Don't see your industry listed?<br className="hidden lg:block" /> Let's talk anyway.
        </h3>
        <p className="text-body">We take on select clients outside our core eight — book a call and we'll be straight with you.</p>
      </div>
      <Link
        to="/contact"
